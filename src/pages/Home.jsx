  ...
  return (
    <>
      <div
        ...
        style={{ backgroundImage: `url('public/uploads/kbc-bubbles-1.png')` }}
      >
      ...
      <div className="container mx-auto my-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="card bg-base-100 shadow-md">
            <figure>
              <img src="/path-to-image1.jpg" alt="Specialty 1" />
            </figure>
          ...
          <div className="card bg-base-100 shadow-md">
            <figure>
              <img src="/path-to-image2.jpg" alt="Specialty 2" />
            </figure>
            <div className="card-body">
          ...
          <div className="card bg-base-100 shadow-md">
            <figure>
              <img src="/path-to-image3.jpg" alt="Specialty 3" />
            </figure>
            <div className="card-body">
